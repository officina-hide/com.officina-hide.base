...
INSERT INTO FX_View
	(
	FX_View_ID, FX_View_Name, FD_Name, FD_Description, FD_Table_ID,
	FD_Group_ID, FD_Created, FD_CreatedBy, FD_Updated, FD_UpdatedBy
	)
	VALUES
	(100, 'FX_FD_Table_View', 'テーブル情報単票画面', 'テーブル情報の内容を登録・変更する為の単票画面', 103
	, 101, '2021/08/23 11:00:00', 100, '2021/08/23 12:00:00', 100),
	(101, 'FX_Menu', '総合メニュー', '各機能への遷移を管理する。', 0
	, 101, '2021/08/23 11:00:00', 100, '2021/08/23 12:00:00', 100)
;
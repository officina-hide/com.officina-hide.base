...
import com.officina_hide.base.model.FDReferenceList;
...
public class CreateBaseInformation {
	...
	public void execute(FD_EnvData env) {
		...
		//テーブル項目に関連するリファレンス情報を登録する。
		column.addRefData(env);
		...
		table.addData(env, I_FD_TableColumn.TABLE_ID, I_FD_TableColumn.Table_Name, I_FD_TableColumn.NAME, I_FD_TableColumn.COMMENT);

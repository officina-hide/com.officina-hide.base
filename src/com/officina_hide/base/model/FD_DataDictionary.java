...
public class FD_DataDictionary extends FD_DB implements I_FD_DataDictionary {
	...
	public void addData(FD_EnvData env, String tableName) {
		...
		case I_FD_Column.Table_Name:
			...
			column.add(env, 0, Table_ID, COLUMNNAME_FD_DataDictionary_ID, FD_Item_ID, 0, true, true, null);
			column.add(env, 0, Table_ID, COLUMNNAME_FD_DataDictionary_Name, FD_Item_String, 100, false, false, null);

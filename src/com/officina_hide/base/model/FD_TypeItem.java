...
public class FD_TypeItem extends FD_DB implements I_FD_TypeItem {
	...
	public void addData(FD_EnvData env, String tableName) {
		...
		case I_FD_Column.Table_Name:
			...
			column.add(env, 0, Table_ID, COLUMNNAME_FD_TypeItem_ID, FD_Item_ID, 0, true, true, null);
			column.add(env, 0, Table_ID, COLUMNNAME_FD_TypeItem_Name, FD_Item_String, 100, false, false, null);
			column.add(env, 0, Table_ID, COLUMNNAME_FD_Type_ID, FD_Item_ID, 0, false, false, null);
